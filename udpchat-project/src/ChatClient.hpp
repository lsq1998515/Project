    ...
    public:
        ...
        bool Register()
        {
            ...
            while(1)
            {
                ...
                std::cin>>PasswdOne;
                std::cout<<"Please Enter Your Passsword again:";
            ...
            if(recv_size < 0 )
            {
                LOG(ERROR,"Recv reguster responce failed")<<std::endl;
                return false;
            }
            else if(recv_size ==0)
            {
        ...
        bool Login()
        {
            ...
            if(recv_size < 0 )
            {
                LOG(ERROR,"Recv Login responce failed")<<std::endl;
                return false;
            }
            else if(recv_size ==0)
            {
       ...
       // Udp 数据的收发 
        ...
        bool RecvMsg(std::string* msg)
        {
            ...
            if(recv_size < 0)
            {
                LOG(ERROR, "recv msg from server failed")<<std::endl;
                return false;
            }
